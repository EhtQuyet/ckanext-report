...
from ckanext.report.logic import schema
...
class TestReport():
    ...
    @pytest.mark.ckan_config('ckanext.report.allow_html', 'True')
    ...
    @pytest.mark.ckan_config('ckanext.report.allow_html', False)
    ...
    def test_blog_index(self, app):
        user = factories.Sysadmin()
        env = {'REMOTE_USER': user['name'].encode('ascii')}
        endpoint = 'report.blog_index' if ckan_29_or_higher else 'blog_index'
    ...
    def test_organization_pages_index(self, app):
        ...
        endpoint = 'report.organization_pages_index' if ckan_29_or_higher else 'organization_pages_index'
    ...
    def test_group_pages_index(self, app):
        ...
        endpoint = 'report.group_pages_index' if ckan_29_or_higher else 'group_pages_index'
    ...
    def test_unicode(self, app):
        ...
        if toolkit.check_ckan_version(min_version='2.9.0'):
            ...
            assert u'<a href="/report/page_unicode">Tïtlé</a>' in response.get_data(as_text=True)
            ...
            assert u'<a href="/report/page_unicode">Tïtlé</a>' in response.unicode_body
    ...
    def test_pages_saves_custom_schema_fields(self, app):
        ...
        with mock.patch('ckanext.report.actions.update_pages_schema', return_value=mock_schema):
            helpers.call_action(
